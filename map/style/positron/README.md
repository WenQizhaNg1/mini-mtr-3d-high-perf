...
The local daytime palette takes a restrained Mapbox Light-inspired direction: cool grey land, pale blue water, muted green parks, white roads and slate labels. This is an adaptation of Positron, not an official Mapbox style. Local adaptations:
...
- The daytime building layer is hidden below zoom 16 and rises smoothly to full height at zoom 17 using the tileset's `render_height` and `render_min_height` fields.
...
- Road labels appear at closer zooms with lighter halos and wider spacing; place labels use mixed case and a clearer colour hierarchy.
